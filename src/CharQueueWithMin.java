...
public interface CharQueueWithMin<T> {
    ...
    /**
     * Defines the methods for a FIFO queue that handles characters with min char value
     */
        ...
        /**
         * return without removing the minimum item of the queue
         *
         * @return minimum item of the queue
         * @throws NoSuchElementException if the queue is empty
         */
